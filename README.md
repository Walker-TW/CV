...
|:-:|:-:|:-:|
|<p align="center"><a href="https://algo-visualiser.herokuapp.com/"><img src="./images/heroku-image.png"  height="32" width="32"></a><br><p align="center"><a href="https://github.com/Walker-TW/Algorithm-Visualizer"><img src="./images/GitHub-120px.png"  height="32" width="32"></a></p>| __'The Algo Visualizer'__, - Built in quarantine with another using zoom and VSCode Live Share its a project made outside of Makers to visually demonstrate the pro’s and con’s of various graph traversal algorithms. Users are able to draw walls, set start points/end points and view statistics of runtimes/shortest paths. Built in ReactJS and tested using Enzyme/Jest. |ReactJS, HTML, CSS, Express, Jest, Bootstrap|
